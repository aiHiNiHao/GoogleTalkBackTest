...
public class TestSession {
    ...
    public TestSession(Context context, JSONObject test, int id) throws JSONException {
        final String titleResourceName = JsonUt.getString(test, JSON_KEY_TITLE);
        final String descriptionResourceName = JsonUt.getString(test, JSON_KEY_DESCRIPTION);
        ...
        final JSONArray contents = JsonUt.getJsonArray(test, JSON_KEY_TESTCONTENT);
    ...
    private BaseTestContent createContent(Context context, JSONObject content) throws
        ...
        final String subtitleResourceName = JsonUt.getString(content, JSON_KEY_SUBTITLE);
        final String descriptionResourceName = JsonUt.getString(content, JSON_KEY_DESCRIPTION);
        final String className = JsonUt.getString(content, JSON_KEY_CLASSNAME);
