 ...
 */
public class SpeechController implements TalkBackServiceTest.KeyEventListener {
    ...
    /** The parent service. */
    private final TalkBackServiceTest mService;
    ...
    public SpeechController(TalkBackServiceTest context,
                            FeedbackController feedbackController) {
        if (feedbackController == null) throw new IllegalStateException();

        mService = context;
        mService.addServiceStateListener(new TalkBackServiceTest.ServiceStateListener() {
            @Override
            public void onServiceStateChanged(int newState) {
                if (newState == TalkBackServiceTest.SERVICE_STATE_ACTIVE) {
                    setProximitySensorState(true);
                } else if (newState == TalkBackServiceTest.SERVICE_STATE_SUSPENDED) {
