...
public class ListMenuManager implements MenuManager, AccessibilityEventListener {
    ...
    public ListMenuManager(TalkBackServiceTest service) {
        mService = service;
    ...
    private boolean needFocusDelay(int actionId) {
        ...
        if (actionId == R.id.pause_feedback || actionId == R.id.talkback_settings || actionId == R.id.enable_dimming || actionId == R.id.disable_dimming || actionId == R.id.tts_settings) {
            return false;
        }
