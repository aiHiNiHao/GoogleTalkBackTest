...
public class TalkBackPreferencesActivity extends Activity {
    ...
    public static class TalkBackPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (TalkBackServiceTest.isInArc()) {
        ...
        public void onResume() {
            super.onResume();
            TalkBackServiceTest talkBackService = TalkBackServiceTest.getInstance();
        ...
        private void assignTtsSettingsIntent() {
            ...
            Intent ttsSettingsIntent = new Intent(TalkBackServiceTest.INTENT_TTS_SETTINGS);
        ...
        private void updateTalkBackShortcutStatus() {
            ...
            if (Build.VERSION.SDK_INT >= ProcessorVolumeStream.MIN_API_LEVEL) {
                preference.setEnabled(
                        TalkBackServiceTest.getInstance() != null || preference.isChecked());
            } else {
                final PreferenceGroup category = (PreferenceGroup) findPreferenceByResId(
                        R.string.pref_category_miscellaneous_key);
                if (category == null) {
        ...
        private void updateDimingPreferenceStatus() {
            ...
            final TalkBackServiceTest talkBack = TalkBackServiceTest.getInstance();
            ...
            dimPreference.setEnabled(
                    TalkBackServiceTest.isServiceActive() || dimPreference.isChecked());
            dimPreference.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    if (dimPreferenceOn) {
                        ...
                        if (!TalkBackServiceTest.isServiceActive()) {
         ...
         * updates atomically.
         *
         * TODO: Move this method to TalkBackServiceTest.
         */
        ...
        private boolean setTouchExplorationRequested(boolean requestedState) {
            ...
            if(requestedState && TalkBackServiceTest.getInstance() != null) {
                TalkBackServiceTest.getInstance().showTutorial();
            }
         ...
         * enable or disabled.
         */
        private final TalkBackServiceTest.ServiceStateListener mServiceStateListener =
                new TalkBackServiceTest.ServiceStateListener() {
                    @Override
