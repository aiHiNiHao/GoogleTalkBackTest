 ...
 */
public final class InCallScreenFormatterKK implements EventSpeechRule.AccessibilityEventFormatter {
    private static final int MIN_EVENT_TEXT_COUNT = 2;

    private static final int INDEX_UPPER_TITLE = 0;
    private static final int INDEX_SUBTITILE = 1;

    @Override
    public boolean format(AccessibilityEvent event, TalkBackServiceTest context, Utterance utterance) {
