...
public final class TextFormatters {
    ...
    public static final class ChangedTextFormatter
        ...
        @Override
        public boolean format(AccessibilityEvent event, TalkBackServiceTest context,
                              Utterance utterance) {
        ...
        private void notifyMaxLengthReached(AccessibilityEvent event,
                                            TalkBackServiceTest context, Utterance utterance) {
        ...
        private int formatInternal(AccessibilityEvent event, TalkBackServiceTest context,
                                   Utterance utterance) {
    ...
    public static final class SelectedTextFormatter
        ...
        private boolean formatInternal(AccessibilityEvent event, TalkBackServiceTest context,
                                       Utterance utterance) {
        ...
        private CharSequence getUnselectedText(TalkBackServiceTest context, AccessibilityEvent event,
        ...
        private CharSequence getSelectedText(TalkBackServiceTest context, AccessibilityEvent event,
                                             CharSequence text, int fromIndex, int toIndex,
                                             int lastToIndex) {
         ...
         */
        private CharSequence getSubsequence(TalkBackServiceTest context,
    ...
    private static boolean shouldSpeakPasswords(TalkBackServiceTest service) {
        if (service == null) {
            return false;
        }
