 ...
 */
public class TelevisionNavigationController implements TalkBackServiceTest.KeyEventListener {
    ...
    public TelevisionNavigationController(TalkBackServiceTest service) {
        mService = service;
