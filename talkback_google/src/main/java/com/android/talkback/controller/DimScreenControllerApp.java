...
public class DimScreenControllerApp implements DimScreenController,
    ...
    private void initView() {
        if (mViewParams == null || mView == null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP_MR1) {
                mViewParams.type = LayoutParams.TYPE_ACCESSIBILITY_OVERLAY;
            } else {
                mViewParams.type = LayoutParams.TYPE_SYSTEM_ERROR;
            }
    ...
    public void showDimScreenDialog() {
        ...
        mDimDialog = new AlertDialog.Builder(TalkBackServiceTest.getInstance())
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP_MR1) {
            mDimDialog.getWindow().setType(LayoutParams.TYPE_ACCESSIBILITY_OVERLAY);
        } else {
            mDimDialog.getWindow().setType(LayoutParams.TYPE_SYSTEM_ERROR);
        }
