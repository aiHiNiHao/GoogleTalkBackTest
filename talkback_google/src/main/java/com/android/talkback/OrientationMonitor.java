...
public class OrientationMonitor {
    ...
    public OrientationMonitor(SpeechController speechController, TalkBackServiceTest context) {
    ...
    /**
     * Called by {@link TalkBackServiceTest} when the configuration changes.
     *
