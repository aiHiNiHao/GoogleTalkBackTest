...
public class SideTapManager extends BroadcastReceiver
    ...
    /**
     * @param context TalkBackServiceTest whose {@code performCustomGesture}
     * will be called when taps are detected
     */
    public SideTapManager(TalkBackServiceTest context, GestureController gestureController) {
    ...
    public void onSingleTap(long timeStamp) {
        boolean talkBackActive = TalkBackServiceTest.isServiceActive();
