 ...
 */
public class KeyboardLockMonitor implements TalkBackServiceTest.KeyEventListener {

    private final SpeechController mSpeechController;
    private final Context mContext;

    public KeyboardLockMonitor(SpeechController speechController, TalkBackServiceTest context) {
