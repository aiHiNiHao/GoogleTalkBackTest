 ...
 * feedback.
 */
public class TalkBackServiceTest extends AccessibilityService
    ...
    private static TalkBackServiceTest sInstance = null;
    ...
    private final static String LOGTAG = "TalkBackServiceTest";
    ...
    /** {@link BroadcastReceiver} for tracking battery status changes. */
    ...
    private TalkBackAnalytics mAnalytics;
    ...
    public void disableTalkBack() {
        ...
        TalkBackServiceTest.getInstance().getSpeechController().speak(
...
//
    ...
    public static int getServiceState() {
        final TalkBackServiceTest service = getInstance();
        if (service == null) {
    ...
    /**
     * Whether the current TalkBackServiceTest instance is running and initialized.
     ...
     */
    public static TalkBackServiceTest getInstance() {
        return sInstance;
    }
    ...
    private void initializeInfrastructure() {
        ...
        if (mKeyComboManager != null) {
            ...
            // Search mode should receive key combos immediately after the TalkBackServiceTest.
        ...
        public boolean onComboPerformed(int id) {
            switch (id) {
                ...
                case KeyComboManager.ACTION_BACK:
                    TalkBackServiceTest.this.performGlobalAction(GLOBAL_ACTION_BACK);
                    return true;
                case KeyComboManager.ACTION_HOME:
                    TalkBackServiceTest.this.performGlobalAction(GLOBAL_ACTION_HOME);
                    return true;
                case KeyComboManager.ACTION_NOTIFICATION:
                    TalkBackServiceTest.this.performGlobalAction(GLOBAL_ACTION_NOTIFICATIONS);
                    return true;
                case KeyComboManager.ACTION_RECENTS:
                    TalkBackServiceTest.this.performGlobalAction(GLOBAL_ACTION_RECENTS);
                    return true;
    ...
    private final SpeechController.UtteranceCompleteRunnable mDisableTalkBackHandler =
            new SpeechController.UtteranceCompleteRunnable() {
                ...
                public void run(int status) {
                    ...
                    TalkBackServiceTest service = TalkBackServiceTest.getInstance();
                    if (service != null) {
                        service.disableSelf();
                    }
                }
     ...
     * <p>
     * {@link TalkBackServiceTest#addServiceStateListener(ServiceStateListener)}
     * {@link TalkBackServiceTest#removeServiceStateListener(ServiceStateListener)}
     * {@link TalkBackServiceTest#SERVICE_STATE_INACTIVE}
     * {@link TalkBackServiceTest#SERVICE_STATE_ACTIVE}
     * {@link TalkBackServiceTest#SERVICE_STATE_SUSPENDED}
     */
